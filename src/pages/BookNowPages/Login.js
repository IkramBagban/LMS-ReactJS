...
const LoginPage = ({ Password, onLoginSuccess }) => {
      ...
      try {
        ...
        data.some((obj) => {
          ...
          if (
            ...
            Object.values(obj).includes(password)
          ) {
            ...
            console.log("selected emiarate", selectedEmirate);
