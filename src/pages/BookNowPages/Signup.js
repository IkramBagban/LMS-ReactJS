    ...
    try {
      ...
      try {
        const dummyData =  {
            ...
            apartment: "c2",
            address: "address",
            contact_number: "23233223",
            alter_Contact_Number: "23233223",
        ...
        // const res = await postSignUp(dummyData);
      ...
      data.some((obj) => {
        if (
          Object.values(obj).includes(input.email) &&
          Object.values(obj).includes(input.Password)
        ) {
    ...
    <div className={classes.container}>
      <div className="">
        <section className={classes.section}>
          ...
          >
            <h3 className="">
              <strong>Signup to Earn Points with our Loyalty Program</strong>
            </h3>
          </div>
