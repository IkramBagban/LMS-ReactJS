    ...
    <Modal show={showModal} onHide={handleCloseModal}>
      ...
      <Modal.Body className={styles["custom-modal-body"]}>
        ...
        <table
          width="480"
          id="sales"
          className={styles["final-table1"]}
          cellPadding="0"
          cellSpacing="0"
        >
          <thead>
            <tr
              className={styles["frm-fld-tabletd1"]}
              cellPadding="0"
              cellSpacing="0"
            >
          ...
          <tbody>
            {orderDetails.order_item?.map((item, index) => (
              <tr key={index}>
                ...
                <td
                  className={styles["frm-fld-tabletd2"]}
          ...
          <tfoot style={{ color: "#60d0e4 !important" }}>
            <tr>
              <td colSpan="3" style={{ paddingTop: 25 }}>
                <strong className={styles["frm-fld-tabletd3"]}>
                  Total Items :{" "}
                </strong>
                <strong className={styles["frm-fld-tabletd3"]}>
                  {noOfItems}
